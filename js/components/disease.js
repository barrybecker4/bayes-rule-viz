...
/**
 * Modules to interactively visualize disease testing using Bayes' rule
...
var sankeyViewer, vennDiagramViewer, bayesRuleViewer;
 ...
 */
function init(totalPopulation, initialPctDiseased, initialTestAccuracy) {
    ...
    bayesRuleViewer = bayesRuleView("#bayes-rule-view", graph, TOTAL_POPULATION);
    vennDiagramViewer = vennDiagramView("#venn-diagram-view", graph, TOTAL_POPULATION);
    sankeyViewer = sankeyView("#sankey-view", graph);
    updateViews();
